import 'package:hufut/deqemezmurData.dart';
import 'package:hufut/fontsGuide.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:foldable_sidebar/foldable_sidebar.dart';
import 'package:swipedetector/swipedetector.dart';
class Deqemezmur extends StatefulWidget {
  static const String id = 'DEQE';

  @override
  _DeqemezmurState createState() => _DeqemezmurState();
}
class _DeqemezmurState extends State<Deqemezmur> {
  FSBStatus status;
  int i = 0;
  @override
